/*
     ...
     - DropTail queues 
     - Tracing of queues and packet receptions to file "group34_trace.tr"
     - Pcap traces also generated in the following files
         "group34-$n-$i.pcap" where n and i represent node and interface
*/
...
main (int argc, char *argv[])
{
    ...
    NodeContainer nc;
        //Create 6 nodes indexed from 0 to 5
    nc.Create (6); 
    ...
    //Set properties for router-router connections
    ...
    p2p.SetQueue ("ns3::DropTailQueue", "MaxBytes", StringValue ("384000")); // DropTailQueue
    ...
    for(i=0;i<10;i++){
        ...
        ftpSourceApp.Start (Seconds (3));
        ftpSourceApp.Stop (Seconds (10.0));
        ftpSinkApp.Start (Seconds (3));
    ...
    flowMonitor->SerializeToXmlFile("diff_start.xml", false,false);
}
